...
$scope.update_id = function(cus_id) 
	...
	{		
		...
		.success(function(data, status, headers, config) 
		{
			if(data.success == 1)
			{
				...
				window.location = "view_hospital.html";
				//location.reload(); 
				return;				
			}
	...
	$http.post('get_booking_status.php', {'email': $scope.cook_user_email})
	.success(function(data, status, headers, config) 
	{
			$scope.user_booking_details = data.details;
    });
	
	$http.post('get_booking_user_status.php', {'email': $scope.cook_work_email})
	.success(function(data, status, headers, config) 
	{
	...
	.success(function(data, status, headers, config) 
	{
			$scope.user_reg_details = data.details;
    });
	
/****************************************************************************/
/************************** Add Complaint *********************************/
/****************************************************************************/
	$scope.create_hospital = function() 
	{		
		$http.post('create_hospital.php', {
...
/************************** Student Update *********************************/
/****************************************************************************/
$scope.update_hospital = function(cus_id,field_1,field_2,field_3,
								 field_4,field_5,field_6,field_7,field_8) 
	{
		window.location = "update_hospital.html";
		$cookieStore.put("cook_cus_id",cus_id);
...
$scope.update_booking = function(cus_id,email,field_1,field_2) 
	{
		window.location = "update_booking_slot.html";
		$cookieStore.put("cook_cus_id",cus_id);
	...
	$scope.update_booking_1 = function(cus_id,email,field_1,field_2,field_3,field_4) 
	{
	...
	{		
		$scope.field_4 = document.getElementById('sales_from_date').value;
		$scope.field_5 = "Nil";
		$scope.field_7 = "Nil";

		$http.post('save_booking.php',{
		...
		$scope.save_booking_1 = function() 
	{		
		$scope.field_5 = "Nil";

		$http.post('save_booking_1.php',{
		'cus_id':$scope.cook_cus_id,'email':$scope.cook_email,'field_1':$scope.cook_field_1,'field_2':$scope.cook_field_2,
		'field_3':$scope.cook_field_3,'field_4':$scope.cook_field_4,'field_5':$scope.field_5,
...
$scope.update_medicine = function(cus_id,field_7,field_8,field_9,field_10,field_11) 
	{
		window.location = "update_medicine.html";
		$cookieStore.put("cook_cus_id",cus_id);
		$cookieStore.put("cook_field_7",field_7);
		$cookieStore.put("cook_field_8",field_8);
	...
	{		
		...
		$http.post('save_medicine.php',{
		'cus_id':$scope.cook_cus_id,'field_1':$scope.cook_field_8,'field_2':$scope.cook_field_9,
		'field_3':$scope.cook_field_10,'field_4':$scope.cook_field_11,
		'email':$scope.cook_field_7,'admin_email':$scope.cook_email})
		.success(function(data, status, headers, config) 
		{
			if(data.success == 1)
			{
...
$scope.view_history = function(field_7) 
	{
	...
	$http.post('get_history.php', {'email':$scope.cook_field_7})
	.success(function(data, status, headers, config) 
	{
			$scope.all_report_details = data.details;
    });
	
	$http.post('get_all_history.php', {'email':$scope.cook_user_email})
	.success(function(data, status, headers, config) 
	{
			$scope.all_pres_details = data.details;
    });
	
$scope.update_slot = function(email,field_2) 
	{
		window.location = "view_user_slot.html";
		$cookieStore.put("cook_email",email);
	...
	$http.post('get_all_user_slot.php', {'email': $scope.cook_email})
	.success(function(data, status, headers, config) 
	{
			$scope.user_all_book_details = data.details;
    });
	
	$http.post('get_user_slot.php', {'email': $scope.cook_work_email})
	.success(function(data, status, headers, config) 
	{
			$scope.user_all_slot_details = data.details;
    });
	
	
	$scope.print_card = function(email,name,mobile) 
	{
		window.location = "printqr.php";
		$cookieStore.put("cook_email",email);
		$cookieStore.put("cook_name",name);
		$cookieStore.put("cook_mobile",mobile);
		return;
